...
state_size = 5 #number of previous steps to consider
...
for e in range(EPISODES):
    ...
    for time in range(1000):
        ...
        if (prev_ob == [0, 0, 0, 0, 0]): #removing null value states from consideration
            break
        #     print(e * 2, prev_ob)

        next_state = np.reshape(prev_ob, [1, state_size])
